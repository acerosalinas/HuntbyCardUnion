...
// Display face for the wordmark and hero headings only - a "sealed vault /
// collector's catalog" character Geist doesn't carry on its own. Everything
// else (buttons, labels, data, body copy) stays on Geist.
